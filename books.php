...
<main role="main">
	...
	<div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-8">
                            ...
                            <?php if(isset($_POST['submit']))
                            {
                                ...
                                $query =" select * from books where product_name = '$keyword'";
                            ...
                            <div class="container">
                                        <div class="col-md-4" >
                                           <div class="card mb-4 shadow-sm">
                                               <img src="images/img/<?php echo $row['book_img'];?>"width="200px" height="230px"style="padding-top: 5rem;">
  ...
  <div class="album py-5 bg-light" style="padding-top: 5rem; padding-bottom: 4rem;">
    ...
    <div class="container">
      <div class="row">
        <?php
           $query ="select * from books where product_cat = 'Books' ";
            $run = mysqli_query($conn, $query);
            while($row= mysqli_fetch_array($run)){
          ?>
       <div class="col-md-4">
