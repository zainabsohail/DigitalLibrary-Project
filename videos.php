	...
	<div class="row justify-content-center">
                        <div class="col-12 col-md-10 col-lg-8">
                            ...
                            <?php if(isset($_POST['submit']))
                            {
                                ...
                                $query =" select * from videos where product_name = '$keyword'";
          ...
          <div class="card mb-4 shadow-sm">
               <video width="320" height="240" controls>
                   <source src="videos/<?php echo $row['product_desc'];?>"style="padding-top: 5rem;">
               </video>
  ...
  <div class="album py-5 bg-light" style="padding-top: 10rem; padding-bottom: 4rem;">
    <div class="container">
      <div class="row">
         ...
         <?php
           $query ="select * from videos where product_cat = 'Videos' ";
            $run = mysqli_query($conn, $query);
            while($row= mysqli_fetch_array($run)){
          ?>
        <div class="col-md-4">
